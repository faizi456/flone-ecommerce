            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input class="billing-address" placeholder="House number and street name" type="text" value="{{$user->address}}" name="address">
                                        @error('address')
                                            <small id="msg">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="billing-info mb-20">
                                        ...
                                        <input type="text" value="{{$user->postcode}}" name="postcode">
                                        @error('postcode')
                                            <small id="msg">{{ $message }}</small>
                                        @enderror
                                    </div>
                ...
                <div class="col-lg-5">
                    <div class="your-order-area">
                                ...
                                <div class="your-order-middle">
                                    <ul>
                                        ...
                                        @foreach($cart_products as $product)
                                            <li>
                                                <span class="order-middle-left">{{$product->product_name}}</span> <span class="order-price">RS. {{$product->subTotal}} </span>
                                            </li>
                                            @php
                                ...
                                <div class="payment-accordion element-mrg">
                                    <div class="panel-group" id="accordion">
                                        <div class="panel payment-accordion">
                                            ...
                                            <div id="method1" class="panel-collapse collapse " data-bs-parent="#accordion">
                        ...
                        <div class="row mt-25">
                            <div class="col-12">
                                <button class="btn checkout-btn" type="submit" ><a>Place Order</a></button>
                            </div>
                        </div>
                    </div>
                </div>
