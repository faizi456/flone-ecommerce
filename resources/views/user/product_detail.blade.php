                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="{{asset($images[1])}}" alt="product-nav-img">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product__details--info">
                        <form action="#">
                            ...
                            <div class="guarantee__safe--checkout">
                                ...
                                <img class="guarantee__safe--checkout__img" src="FrontendFiles/img/other/safe-checkout.png" alt="Payment Image">
                            </div>
                        </form>
                    </div>
                </div>
