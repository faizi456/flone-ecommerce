                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__categories--menu">
                                    <li class="widget__categories--menu__list">
                                        <a href="{{route('viewSubCategory',$subcategory->sub_id)}}">
                                            <label class="widget__categories--menu__label d-flex align-items-center mt-2 mb-2">
                                                ...
                                                <div class="col mb-30">
                                                    <div class="product__items ">
                                                        ...
                                                        <div class="product__items--content">
                                                            <span class="product__items--content__subtitle">Code: {{$product->product_code}}</span>
                                                            ...
                                                            <ul class="product__items--action d-flex">
                                                                <li class="product__items--action__list">
                                                                    <a class="product__items--action__btn add__to--cart" href="{{url('/cart')}}">
