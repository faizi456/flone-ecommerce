...
<html dir="ltr">
  <head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('adminfiles/assets/images/favicon.png') }}"/>
    <!-- Custom CSS -->
    <link href="{{asset('adminfiles/dist/css/style.min.css')}}" rel="stylesheet" />
  ...
  <body>
    <div class="main-wrapper">
      ...
      <div
        ...
        style="background: url( {{ asset('adminfiles/assets/images/big/auth-bg.jpg') }} ) no-repeat center center"
      >
        <div class="auth-box">
          <div id="loginform">
            <div class="logo">
              <span class="db"><img src="{{ asset('adminfiles/assets/images/logo-icon.png') }}" alt="logo" /></span>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <form class="form-horizontal mt-3" id="loginform" method="post" action="{{ route('getLogin') }}">
                  @csrf
